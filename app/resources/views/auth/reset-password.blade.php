{{-- Password reset page: user sets a new password using the emailed token. --}}
<!DOCTYPE html>
<html lang="{{ app()->getLocale() }}">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>{{ __('ui.reset_password') }} — {{ __('ui.app_name') }}</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        h1 { font-size: 22px; font-weight: 600; text-align: center; margin-bottom: 24px; }
...
<body>
    <div class="card">
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <button type="submit" class="btn btn-primary">{{ __('ui.reset_password') }}</button>
        </form>
    </div>
</body>
</html>
