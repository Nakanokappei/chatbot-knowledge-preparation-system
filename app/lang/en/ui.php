...
return [
    ...
    'cannot_delete_dataset_with_kus' => 'Cannot delete: this dataset still has knowledge units. Delete the clustering runs first.',
    ...
    'openai_key_configured'         => 'OpenAI API key is configured and valid.',
    'openai_key_not_configured'     => 'OpenAI API key is not set or invalid.',
    'openai_key_env_hint'           => 'Set OPENAI_API_KEY in the .env file.',
    'openai_key_env_only'           => 'API key is now managed via .env file. UI configuration has been removed.',
    'openai_key_required_first'     => 'OpenAI models will be available once a valid API key is configured.',
    ...
    'parameter_search_report_export' => '📊 Export report',
    ...
    'dataset'                       => 'Dataset',
    'sweep_sample_size'             => 'Sweep sample size',
    'optimisation_target'           => 'Optimisation target',
    'noise_filter'                  => 'Noise-ratio filter',
    'drop_noise_above'              => 'Drop candidates with noise > :pct%',
    'silhouette_chart'              => 'Silhouette score chart',
    'no_scoreable_trials'           => 'No scoreable trials.',
    'selected_configuration'        => 'Selected Configuration',
    'no_accepted_candidate'         => 'No candidate passed the noise-ratio filter.',
    'algorithm'                     => 'Algorithm',
    'noise_count'                   => 'Noise count',
    'max_cluster_share'             => 'Max cluster share',
    'why_this_one'                  => 'Why this one',
    'why_top_score'                 => 'Highest target score among candidates passing the noise-ratio filter.',
    'why_full_data'                 => 'High sample scores tend to hold up when the configuration is re-run on full data.',
    'top_groups_by_volume'          => 'Top groups by volume',
    'group_name'                    => 'Group name',
    'estimated_total_rows'          => 'Estimated total rows',
    'share_of_total'                => 'Share of total',
    'accepted_candidates'           => 'Accepted Candidates (Ranked)',
    'ranking_uses_target'           => 'Ranking follows the selected target (:target). The three right-most columns score the same trials under the other targets so you can see how the choice would differ for another use case.',
    'chart_no_explainer'            => 'The "Chart #" column is the trial\'s position on the silhouette chart above (the chart is sorted by silhouette, the table by target score, so the orderings differ).',
    'ratio'                         => 'ratio',
    'max_share'                     => 'Max share',
    'rejected_noise_section'        => 'Rejected — Noise-Ratio Filter',
    'rejected_noise_explainer'      => 'Candidates with sample-noise over :pct% are dropped — a handful of tiny clusters surrounded by noise has no operational value.',
    'rejected_degenerate_section'   => 'Rejected — No Cluster Structure',
    'rejected_degenerate_explainer' => 'Candidates that produced fewer than two valid clusters or could not be scored.',
    'score_progression_by_method'   => 'Score Progression by Method',
    'glossary_heading'              => 'Glossary',
    'glossary_description'          => 'Description and parameters',
    'quality'                       => 'Quality',
