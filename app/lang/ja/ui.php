...
return [
    ...
    'approved' => '承認済み',
    'archived' => 'アーカイブ済み',
    'cannot_delete_published' => '公開中のパッケージは削除できません。先にアーカイブしてください。',
    'package_deleted' => ':name を削除しました。',
    'delete_package_confirm' => ':name を削除しますか？この操作は取り消せません。',
    'bulk_actions' => '一括操作',
    'approve_all' => 'すべて承認',
    'edit_review' => '編集 / レビュー',
    'cluster' => 'クラスター',
    ...
    'embed_copy_snippet'            => 'スクリプトをコピー',
    'embed_copy_iframe'             => 'iframeをコピー',
    'embed_copy_link'               => 'リンクをコピー',
    ...
    'period_last_week'              => '先週',
    'period_last_7'                 => '過去7日間',
    'period_last_28'                => '過去28日間',
    'period_last_30'                => '過去30日間',
    'period_last_90'                => '過去90日間',
    'period_last_12m'               => '過去12か月',
    'embedding_model_used'          => '埋め込みモデル',
    'occurrence_count'              => '回数',
    'last_asked'                    => '最終質問日',
    ...
    'openai_key_configured'         => 'OpenAI APIキーが設定され、有効です。',
    'openai_key_not_configured'     => 'OpenAI APIキーが未設定または無効です。',
    'openai_key_env_hint'           => '.env ファイルに OPENAI_API_KEY を設定してください。',
    'openai_key_env_only'           => 'APIキーは .env ファイルで管理します。画面からの設定は廃止されました。',
    'openai_key_required_first'     => 'OpenAI APIキーが有効になると、ここからモデルを追加できます。',
    ...
    'parameter_search_report_export' => '📊 レポートを出力',
    ...
    'search_conditions'             => '探索条件',
    'dataset'                       => 'データセット',
    'sweep_sample_size'             => 'スイープのサンプルサイズ',
    'optimisation_target'           => '最適化ターゲット',
    'noise_filter'                  => 'ノイズ比フィルタ',
    'drop_noise_above'              => 'ノイズ :pct% 超の候補は採用候補から除外',
    'silhouette_chart'              => 'シルエットスコアチャート',
    'no_scoreable_trials'           => 'スコア可能な試行がありません。',
    'selected_configuration'        => '採用構成',
    'no_accepted_candidate'         => 'ノイズ比フィルタを通過した候補がありません。',
    'algorithm'                     => '手法',
    'noise_count'                   => 'ノイズ数',
    'max_cluster_share'             => '最大クラスタ占有率',
    'why_this_one'                  => '採用理由',
    'why_top_score'                 => 'ノイズ比フィルタを通過した候補のうち、対象ターゲットのスコアが最も高い。',
    'why_full_data'                 => 'サンプル上の高スコアは、本構成を全データで再走させても再現される傾向がある。',
    'top_groups_by_volume'          => '規模順 主要グループ',
    'group_name'                    => 'グループ名',
    'estimated_total_rows'          => '推定全件数',
    'share_of_total'                => '全体シェア',
    'accepted_candidates'           => '採用候補（ランキング）',
    'ranking_uses_target'           => 'ランキングは選択中ターゲット（:target）に基づきます。右側の3列は同じ候補を別のターゲットで評価した場合のスコアで、用途による選択肢の差を比較できます。',
    'chart_no_explainer'            => '「Chart #」列はチャート上のバー位置に対応します（チャートはシルエットスコア順、表はターゲットスコア順なので並びは異なります）。',
    'ratio'                         => '比率',
    'max_share'                     => '最大占有',
    'rejected_noise_section'        => '却下 — ノイズ比フィルタ',
    'rejected_noise_explainer'      => 'サンプル上のノイズ比が :pct% を超えた候補は除外しています（少数の小さなクラスタが大量のノイズに囲まれている状態は実運用価値が低いため）。',
    'rejected_degenerate_section'   => '却下 — クラスタ構造を形成できず',
    'rejected_degenerate_explainer' => '有効なクラスタが2つ未満となった、もしくはスコアが算出できなかった候補です。',
    'score_progression_by_method'   => '手法別スコア推移',
    'glossary_heading'              => '用語解説 / Glossary',
    'glossary_description'          => '説明とパラメータ',
    'quality'                       => '品質',
    'interpretation'                => '所見',
    'sampled'                       => 'サンプル',
