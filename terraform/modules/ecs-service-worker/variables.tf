# =============================================================================
# ECS Service Worker Module — Input Variables
# =============================================================================
...
variable "worker_task_role_arn" {
  description = "ARN of the IAM role assumed by the running worker container."
  type        = string
}
...
variable "worker_image" {
  description = "Full ECR image URI including tag for the worker container."
  type        = string
}
...
variable "desired_count" {
  description = "Number of worker task replicas to run."
  type        = number
}
...
variable "worker_sg_id" {
  description = "Security group ID attached to the worker tasks."
  type        = string
}
...
variable "sqs_queue_url" {
  description = "URL of the SQS queue polled by the worker."
  type        = string
}
